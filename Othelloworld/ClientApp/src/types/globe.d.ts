...
interface GlobeProps<PolygonData, HtmlData> extends ConfigOptions {
  // Container layout
  width?: number;
  height?: number;
  ...
  polygonGeoJsonGeometry?: Accessor<PolygonData, GeoJsonGeometry>;
  polygonCapColor?: Accessor<PolygonData, string>;
  polygonCapMaterial?: Accessor<PolygonData, Material>;
  polygonSideColor?: Accessor<PolygonData, string>;
  polygonSideMaterial?: Accessor<PolygonData, Material>;
  polygonStrokeColor?: Accessor<PolygonData, string | boolean | null>;
  polygonAltitude?: Accessor<PolygonData, number>;
  polygonCapCurvatureResolution?: Accessor<PolygonData, number>;
  polygonsTransitionDuration?: number;
  polygonLabel?: Accessor<PolygonData, string>;
  onPolygonClick?: (polygon: PolygonData, event: MouseEvent, coords: { lat: number, lng: number, altitude: number }) => void;
  onPolygonRightClick?: (polygon: PolygonData, event: MouseEvent, coords: { lat: number, lng: number, altitude: number }) => void;
  onPolygonHover?: (polygon: PolygonData | null, prevPolygon: PolygonData | null) => void;
  ...
  htmlLat?: Accessor<HtmlData, number>;
  htmlLng?: Accessor<HtmlData, number>;
  htmlAltitude?: Accessor<HtmlData, number>;
  htmlElement?: string | ((d: HtmlData) => HTMLElement);
...
//declare const Globe: React.FunctionComponent<GlobeProps & { ref?: React.MutableRefObject<GlobeMethods | undefined> }>;

//declare const Globe: React.FunctionComponent<GlobeProps<T> & { ref?: React.MutableRefObject<GlobeMethods | undefined> }>;

  //FCwithRef<GlobeProps<any>, GlobeMethods>;
...
interface Polygon extends Coords, CountryInfo { };

declare const Globe: React.FunctionComponent<GlobeProps<CountryInfo, Polygon> & { ref?: React.MutableRefObject<GlobeMethods | undefined> }>;

declare module "globe" {
  export type { GlobeMethods, GlobeProps, Polygon, CountryInfo, Coords };
